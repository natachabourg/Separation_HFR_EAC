...
stations = {'RRK','NNB'};
ncname_in_all = {'RRK_daily_Y2019_M07_Y2021_M12.nc','NNB_daily_Y2019_M07_Y2021_M12.nc'};
...
for s = 1:2
    ...
    disp('We only keep until January 2021');
    vr = vr(:,:,1:550); 
    ...
    clear vr lonr latr mask temp_cov s time
end
