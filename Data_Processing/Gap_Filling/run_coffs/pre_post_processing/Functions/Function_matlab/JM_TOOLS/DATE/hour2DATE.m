function DATE=hour2DATE(time_counter,time_origin)
% MARMAIN 
% 2012/07/12
% JM_TOOLS
...
DATE.julian=time_counter/(24); %%% conversion hour to day since time_origin

DATE.calendar=datestr(DATE.julian + datenum(time_origin, 'yyyy-mm-dd HH:MM:SS'),31);
%%DATE.calendar=datestr(DATE.julian);

DATE.time_origin=datestr(datenum(time_origin, 'yyyy-mm-dd HH:MM:SS'),31);%time_origin;
