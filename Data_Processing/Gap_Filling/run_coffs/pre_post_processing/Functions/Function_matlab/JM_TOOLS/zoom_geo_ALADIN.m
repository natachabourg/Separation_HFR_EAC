function [ PARAM_zoom ] = zoom_geo_ALADIN( PARAM,NAV,ZOOM )
%%% MARMAIN
%%% 2012/10/04
%%% 
%%% geographical zoom 
...
%%% modif - MARMAIN - 2012/11/18: Adaptation ALADIN, grille lat inverse
...
for i_lon = 1 : size(NAV.lon,1)
    ...
    zoom.condition2(i_lon,  NAV.lat(i_lon,:) >= ZOOM.lat(2) & ...
        NAV.lat(i_lon,:) <= ZOOM.lat(1)) =1;
