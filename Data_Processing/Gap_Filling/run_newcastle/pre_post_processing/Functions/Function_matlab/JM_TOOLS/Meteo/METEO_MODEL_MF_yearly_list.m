function [ MODELname ] = METEO_MODEL_MF_yearly_list( PATH_MODEL , PARAM  )
% MARMAIN 
% 2012/11/18
% To create a list of Model files based on grib file provided by Meteo
% France and converted in netcdf by ourself and concatenated by YEAR
%
% Work on ARPEGE, ALADIN and AROME
%
% We can load only one parameter given in input arguments
%
% File must be sorted by year in one directory with all year.
%
