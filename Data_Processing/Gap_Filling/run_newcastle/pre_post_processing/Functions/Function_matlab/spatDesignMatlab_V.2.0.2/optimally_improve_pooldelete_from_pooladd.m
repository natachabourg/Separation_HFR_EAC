function [x,y,avgkrigemsep,infM_1,pooladdx,pooladdy,pooldeletex,pooldeletey]=optimally_improve_pooldelete_from_pooladd(externaldrift,U,x0,y0,pooladdxy,pooldeletexy,sigma2,apriorivar,w,M,delta,xlower,xupper,ylower,yupper,maxiterations,polygon,nx,ny,calc,infM_1,criterion)
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  [x,y,avgkrigemsep]=optimally_improve_pooldelete_from_pooladd(externaldrift,U,x0,y0,pooladdxy,pooldeletexy,sigma2,apriorivar,w,M,delta,xlower,xupper,ylower,yupper,maxiterations,polygon,nx,ny,calc,infM,infM_1,criterion)
%
...
%                 should be applied. These design points may be exchanged to
...
%  save Gomel
%  plot(ximprovepooldeletefrompooladdBoxGomeliso_i,yimprovepooldeletefrompooladdBoxGomeliso_i,'o')
%  hold on
...
%  save Gomel
%  plot(ximprovepooldeletefrompooladdBoxGomeliso_i2,yimprovepooldeletefrompooladdBoxGomeliso_i2,'o')
%  hold on
...
for s=1:maxiterations
   ...
   for i=1:length(pooldeletex)
      h=i
      zz(i)=optimxiyidelete(pooldeletex(i),pooldeletey(i),w,M,U,infM_1,n+n1-1,polygon,criterion,externaldrift);
   end
   ...
   for i=1:length(pooladdx)
      h=i
      zz(i)=optimxiyiadd([pooladdx(i),pooladdy(i)],w,M,U,infM_1,n+n1-1,polygon,criterion,externaldrift);
   end
   kd=find(zz==min(zz)); %the index of the point to be deleted
   kd=kd(1);
   clear zz i
