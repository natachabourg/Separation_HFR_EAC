...
%  cov=covar(h,delta0)
%
%  calculates a theoretical covariance function, which is a convex
%  combination of an exponential and a Gaussian covariance model.
%
%  Inputs:
%
%  h..................the lag
%
%  delta0.............covariance parameters 
%                     =[nugget, sill, exp. range, Gaussian range, mixing parameter]
%
%  Output:
%
%  cov................the value of the covariance function at lag h
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
