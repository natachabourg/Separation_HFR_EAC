...
s.lambda     = [40  20  10 ];                      % geostatistical parameter for exponential model
...
s.n_pts      = [50  50  50 ];                      % number of unknowns in each direction
s.d_pts      = [2   1   0.5];                      % grid spacing in each direction
...
options.solver   = 'fft';                          % solver method: fft (fft-reg, fft-irreg) or standard
options.estvar   = 'speedy';                       % estimation variance method: full, one-point, speedy or none
