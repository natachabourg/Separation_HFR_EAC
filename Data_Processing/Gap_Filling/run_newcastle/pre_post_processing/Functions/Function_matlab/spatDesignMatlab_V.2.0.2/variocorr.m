...
%  The overall sill is standardized to 1.
%
%  Inputs:
%
%  h..................the lag
...
if h==0
  v=delta0(1)/(delta0(1)+delta0(2));
else
  v=1-(delta0(2)*((1-delta0(5))*exp(-3*h/delta0(3))+delta0(5)*exp((-3*h.^2)/(delta0(4)^2))))/(delta0(1)+delta0(2));
end