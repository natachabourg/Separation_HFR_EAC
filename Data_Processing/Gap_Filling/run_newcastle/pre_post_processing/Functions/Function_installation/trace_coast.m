...
function varargout = trace_coast(map_opts)
...
%% Set the projection type, if plot in lon/lat
if plot_lonlat_xy == 1
...
if plot_lonlat_xy == 1
    h_coast = m_plot(xcoast,ycoast,'b','Linewidth',lwc);
else
...
if plot_bath == 1
    ...
    if plot_lonlat_xy == 1
        [C, h_bathy] = m_contour(xbath,ybath,zbath,levels,'Color',[0.5 0.5 0.5],'Linewidth',lwb);
    else
