mask_rrk = ncread('mask_2019_2021_RHED.nc','mask')';
mask_nnb = ncread('mask_2019_2021_SEAL.nc','mask')';


rrk_file = 'daily_2019_2021_RHED_pre.nc';
nnb_file = 'daily_2019_2021_SEAL_pre.nc';
...
left = load('/home/natachab/Bureau/eac_chloro_hfr_analysis/hfr_data_processing/gap_filling/run_newcastle/my_result_folder/log2/outputEof.lftvec');
